...
export const FEATURE_MAP: FeatureEntry[] = [
  ...
  { href: '/lessons/quick', label: '빠른 수업일지 입력', description: '최소 항목만 빠르게 입력', tier: 'archive', roles: ['admin', 'teacher'], hasEntryPoint: false, signalTable: 'lesson_records', signalColumn: 'created_at', note: '수업 마감과 목적 중복 · 진입점 없음', supersededBy: { href: '/lessons/close', label: '수업 마감' } },
  { href: '/study-sessions', label: '자습·클리닉 관리', description: '자습/클리닉/테스트 세션 기록', tier: 'archive', roles: ['admin', 'teacher', 'assistant'], hasEntryPoint: false, signalTable: 'self_study_records', signalColumn: 'created_at', note: '최근 90일 기록 0건', supersededBy: { href: '/timetable', label: '시간표' } },
  ...
  { href: '/private-channel', label: '영어팀 채널', description: '영어팀 전용 메시지 채널', tier: 'archive', roles: ['admin'], hasEntryPoint: true, signalTable: 'private_messages', signalColumn: 'created_at', note: '메시지 0건', supersededBy: { href: '/admin/office', label: '행정 업무' } },
  ...
  { href: '/vocab-test', label: '단어시험 관리', description: '단어시험 배정·결과 확인', tier: 'archive', roles: ['admin', 'teacher', 'assistant'], hasEntryPoint: true, signalTable: 'vocab_test_assignments', signalColumn: 'created_at', note: '최근 90일 배정 0건', supersededBy: { href: '/lessons/close', label: '수업 마감' } },
  { href: '/vocab-generator', label: '단어시험지 제작', description: '문서 업로드로 단어시험지 생성', tier: 'archive', roles: ['admin', 'teacher'], hasEntryPoint: false, signalTable: 'vocab_generated_tests', signalColumn: 'created_at', note: '단어시험 관리와 함께 사용', supersededBy: { href: '/vocab-test', label: '단어시험 관리' } },
  { href: '/math-concepts', label: '개념 퀴즈', description: 'AI 개념 퀴즈 생성·배정', tier: 'archive', roles: ['admin', 'teacher', 'assistant'], hasEntryPoint: true, signalTable: 'math_concept_quizzes', signalColumn: 'created_at', note: '최근 90일 0건', supersededBy: { href: '/lessons/close', label: '수업 마감' } },
  { href: '/quiz-bulk-upload', label: '문제 일괄 업로드', description: '수학 문제 대량 등록', tier: 'archive', roles: ['admin', 'teacher'], hasEntryPoint: false, signalTable: 'math_questions', signalColumn: 'created_at', note: '최근 90일 0건', supersededBy: { href: '/quiz-lookup', label: '문제 조회' } },
  { href: '/quiz-lookup', label: '문제 조회', description: '등록된 문제 검색', tier: 'archive', roles: ['admin', 'teacher'], hasEntryPoint: false, signalTable: 'math_questions', signalColumn: 'created_at', note: '최근 90일 0건', supersededBy: { href: '/materials/math', label: '수학 자료실' } },
  ...
  { href: '/assistant-requests', label: '조교 요청·업무', description: '강사→조교 업무 요청 생성과 조교의 업무 처리·상태 변경을 역할별로 한 화면에서 처리', tier: 'asNeeded', roles: ['admin', 'teacher', 'assistant'], hasEntryPoint: true, signalTable: 'assistant_tasks', signalColumn: 'created_at', compatHrefs: ['/assistant-tasks'], note: '이전 조교 업무 보드(/assistant-tasks) 통합' },
