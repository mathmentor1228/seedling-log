-- Add principal comment fields to weekly_reports
ALTER TABLE public.weekly_reports 
ADD COLUMN IF NOT EXISTS principal_comment text,
ADD COLUMN IF NOT EXISTS principal_comment_enabled boolean DEFAULT false;

-- Update generate_weekly_reports to include week-over-week comparison
...
BEGIN
  ...
  FOR s IN SELECT id, name FROM public.students LOOP
    ...
    ELSE
      ...
      -- Insert comparison sentence after header
