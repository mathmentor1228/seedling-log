-- ========================================
-- Update generate_weekly_reports to use test_title and include english_pass_fail
-- ========================================
    ...
    ELSE
      ...
      FOR subj_name IN SELECT unnest(ARRAY['수학', '과학', '영어', '국어']) LOOP
        ...
        IF subj_lessons > 0 THEN
          ...
          -- Build test sentence using test_title instead of test_name
          test_sentence := '';
          FOR test_rec IN
            ...
            LIMIT 3  -- Show max 3 most recent tests
          LOOP
