    ...
    const aiResponse = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `당신은 학원에서 학생들을 가르치는 수학 교육 전문가입니다. 주어진 수학 개념 PDF의 **모든 내용**을 빠짐없이 분석하여, **수학적 정의와 개념 이해도 확인** 중심의 퀴즈를 생성해야 합니다.

⚠️ 가장 중요한 원칙: "계산 문제 풀이"가 아니라 "수학적 정의와 개념을 정확히 알고 있는가"를 확인하는 데 초점을 맞추세요. 계산 위주의 문제는 절대 내지 마세요.
