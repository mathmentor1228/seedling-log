...
다음 주에는 수업 참여 상황과 과제 진행을 조금 더 유의 깊게 살펴보려 합니다. 궁금하신 부분은 담당 선생님께 편하게 문의해 주세요.`;
  }

  return `${header}

이번 주 학습 내용은 담당 선생님이 남긴 기록을 바탕으로 정리하고 있습니다. 학부모님께 전해 드릴 문안은 표현을 다듬는 중이며, 확정되는 대로 안내드리겠습니다.

수업 중 이해 정도와 과제 흐름은 조금 더 지켜볼 부분으로 두고, 다음 주에 유의 깊게 살피려 합니다.`;
}
